 ...
 * button.c
 *
 * Purpose : debounce the encoder's active-low push-button and classify each
 *           press as a short tap or a long hold, without ever blocking.
 ...
 *
 * Copied from relay/sentinel/src/button.c (guard/comments renamed only).
 *
 * Model:
...
#define BTN_LONGPRESS_MS    2000u   /* >= 2 s hold => abort gesture         */
