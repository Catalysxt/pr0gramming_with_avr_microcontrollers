# Hardware Connections — Logging Thermometer
...
| R1 | 330 Ω resistor | LED current limiter |
...
SDA and SCL are **open-drain**; both devices share the same two wires. A **single pair of pull-up resistors** (4.7 kΩ to VCC) serves the whole bus — do not add a second pair for U3 if U2's breakout already includes them.
